...
export default function Blog() {
  ...
  return (
    <div className="pt-32 pb-24 container mx-auto px-6">
      ...
      >
        <h1 className="text-6xl font-serif mb-8">المدونة</h1>
        <p className="text-xl text-muted-foreground leading-relaxed">
          أفكار حول التصميم والعمليات الإبداعية وأعمال التصميم.
        </p>
      </motion.div>
        ...
        {isLoading ? (
          ...
          <>
            {articles.map((article, i) => (
              ...
              >
                <Link href={`/blog/${article.slug}`} className="grid md:grid-cols-4 gap-8">
                  ...
                  <div className="md:col-span-3">
                    ...
                    <span className="text-sm font-medium underline underline-offset-4 decoration-primary/30 group-hover:decoration-primary transition-all">اقرأ المقال</span>
                  </div>
                </Link>
              </motion.div>
            ))}
